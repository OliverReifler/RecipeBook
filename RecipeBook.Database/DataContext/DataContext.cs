...
namespace RecipeBook.Database
{
    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Recipe recipe1 = new Recipe() { Id = 5, Name = "recipe1" };
            ...
            modelBuilder.Entity<Ingredient>().HasMany(x => x.Recipes).WithMany(y => y.ListOfIngredients).UsingEntity(j => j.ToTable("RecipeIngredients"));
